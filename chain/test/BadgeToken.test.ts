...
describe("BadgeToken", function(){
    ...
    // it("Should mint a token with desired with tokenURI (log result for inspection)", async function(){
    //     const address1 = await account1.getAddress()
    //     await badge.mintTo(address1)
    ...
    // it("Should mint 10 token wth desired tokenURI", async function(){
    //     const address1 = await account1.getAddress()
    ...
    //     expect(await badge.balanceOf(address1)).to.be.equal(10)
    // })
